...
namespace Laboratory_Work_2
{
    public partial class Form1 : Form
    {
        ...
        string MyFName = "";
        private void menuItem1_Click(object sender, System.EventArgs e)  // Закрытие файла
        {
        ...
        private void menuItem2_Click(object sender, EventArgs e)  // Открытие файла
        {
            if (MyFName != "")
            {
        ...
        private void button2_Click(object sender, EventArgs e)  // Первое слово
        {
            int LenText;
        ...
        private void button4_Click(object sender, EventArgs e)  // Замена
        {
            if (result1 < result2)
            {
